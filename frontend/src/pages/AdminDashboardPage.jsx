...
//             <p className="text-sm text-gray-500 mt-1">Stock ≤ 5</p>
//           </div>

//           <div className="bg-white shadow-md rounded-xl p-6 border-t-4 border-yellow-400">
//             <h2 className="text-lg font-semibold text-gray-700 mb-2">Orders</h2>
//             <p className="text-gray-500 text-md">📦 Coming Soon</p>
//           </div>
//         </div>
