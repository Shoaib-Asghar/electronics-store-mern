...
// List of product categories shown on homepage
const categories = [
...
// Component for individual category card (image + title)
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-blue-50 flex flex-col items-center justify-center px-4 py-16">
      ...
      <div className="text-center max-w-2xl">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Link
            to="/login"
            className="bg-gray-800 hover:bg-gray-900 text-white font-semibold py-2 px-6 rounded shadow"
          >
          ...
          <Link
            to="/register"
            className="border border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-semibold py-2 px-6 rounded shadow"
          >
